...
<head>
    ...
    <title>Cotizaciones de seguros | Alliance Broker</title>
...
<body class="sb-nav-fixed">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="overflow-y:scroll;">
                                ...
                                <table class="table table-bordered table-striped" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT * FROM cotizaciones WHERE identificador=1 ORDER BY id DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="max-width: 70px;">
                                                        <form action="codeseguros.php" method="POST" class="d-inline">
                                                            ...
                                                            <button type="submit" name="cliente" class="btn btn-info btn-sm m-1 changebtn">
                                                        ...
                                                        <a href="mailto:<?= $registro['username']; ?>" class="btn btn-primary btn-sm m-1">
                                                            <i class="bi bi-envelope-fill"></i>
                                                        </a>

                                                        <a href="editarcotizacion.php?id=<?= $registro['id']; ?>" class="btn btn-warning btn-sm m-1">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </a>

                                                        <form action="codeseguros.php" method="POST" class="d-inline">
                                                            <button type="submit" name="delete" value="<?= $registro['id']; ?>" class="btn btn-danger btn-sm m-1 deletebtn">
                                        ...
                                        <?php
                                            ...
                                            echo "<td><p> No se encontro ningun usuario </p></td><td></td><td></td><td></td><td></td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                button.addEventListener('click', (e) => {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            fetch('codeseguros.php', {
                                    method: 'POST',
                                    body: formData
                                })
                                .then(response => {
                                    // Realizar acciones posteriores a la eliminación si es necesario
                                    // Por ejemplo, actualizar la interfaz de usuario
                                    // Puedes recargar la página o eliminar la fila correspondiente.
        ...
        button.addEventListener('click', (e) => {
            ...
            const id = e.target.previousElementSibling.value; // Obtener el valor del input hidden del formulario

            // Mostrar la alerta de SweetAlert2 para confirmar la acción
            Swal.fire({
                title: '¿Estás seguro que deseas convertir este registro en un cliente?',
                text: '¡No podrás deshacer esta acción!',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    // Crear un input hidden con el name 'cliente' y el valor del id
