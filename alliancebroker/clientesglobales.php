...
<head>
    ...
    <title>Clientes globales | Alliance Broker</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="overflow-y:scroll;">
                                ...
                                <table class="table table-bordered table-striped" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT * FROM seguros INNER JOIN usuarios ON seguros.email = usuarios.username WHERE usuarios.rol = 5 ORDER BY seguros.id DESC";
                                        $query_run = mysqli_query($con, $query);
                                        if (mysqli_num_rows($query_run) > 0) {
                                            foreach ($query_run as $registro) {
                                        ?>
                                                <tr>
                                                    <td><p><?= $registro['nombre']; ?> <?= $registro['apellidop']; ?> <?= $registro['apellidom']; ?></p></td>
                                                    <td><p><?= $registro['email']; ?></p></td>
                                                    ...
                                                    <td><pre><?= $registro['detalles']; ?></pre></td>
                                                    <td style="max-width: 50px;">
