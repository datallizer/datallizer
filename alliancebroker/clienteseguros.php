...
<head>
    ...
    <title>Clientes de seguros | Alliance Broker</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>CLIENTES DE SEGUROS
                                    <button type="button" class="btn btn-primary btn-sm float-end" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        NUEVO CLIENTE
                                    </button>
                                    <a style="margin:0px 5px;" href="polizas.php" class="btn btn-secondary btn-sm float-end">NUEVA POLIZA</a>
                            ...
                            <div class="card-body" style="overflow-y:scroll;">
                                ...
                                <table class="table table-bordered table-striped" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT * FROM seguros INNER JOIN usuarios ON seguros.username = usuarios.username WHERE usuarios.rol = 6 ORDER BY seguros.id DESC";
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td style="max-width: 50px;">
                                                        <a href="editarusuario.php?username=<?= $registro['username']; ?>#cliente" class="btn btn-warning btn-sm m-1"><i class="bi bi-eye-fill"></i></a>

                                                        <form action="codeseguros.php" method="POST" class="d-inline">
                                                            <button type="submit" name="deletecliente" value="<?= $registro['username']; ?>" class="btn btn-danger btn-sm m-1 deletebtn">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="saveseguro">Guardar cliente</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                const username = e.target.value; // Obtener el valor del botón delete
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        formData.append('deletecliente', username);
