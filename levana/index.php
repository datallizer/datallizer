...
<head>
  ...
  <meta name="description" content="El mejor desarrollo inmobiliario en Aguascalientes. Bienestar, comunidad y comodidad para nuestros residentes.">
    ...
    <meta property="og:title" content="Paseo Levana | Levana">
  ...
  <title>Paseo Levana | Levana</title>
</head>
...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide carrouselhero" data-bs-ride="carousel">
    ...
    <div class="carousel-inner" style="background-color:#436179;">
      ...
      <div class="carousel-item active" data-bs-interval="3000">
        <video src="images/alberca2.mp4" width="100%" autoplay muted loop></video>
        <div class="carousel-caption d-md-block herovideocaption" data-aos="fade-right">
          <h4>CONDOMINIO</h4>
          <h5>PASEOS LEVANA</h5>
          <a href="vialevana.php" class="btn btn-primary mt-2">CONOCE VÍA LEVANA</a>
        </div>
        <div class="half-black-background"></div>
      </div>

      <div class="carousel-item" data-bs-interval="2000">
        <img src="images/caseta.jpg" class="d-block w-100" alt="acceso">
        <div class="carousel-caption d-md-block">
          <h5>ACCESO CONTROLADO</h5>
        </div>
      </div>
      <div class="carousel-item" data-bs-interval="3000">
        <img src="images/mesasterraza.jpg" class="d-block w-100" alt="terraza">
        <div class="carousel-caption d-md-block">
          <h5>TERRAZA CON ALBERCA</h5>
        </div>
      </div>
      <div class="carousel-item" data-bs-interval="3000">
        <img src="images/petpark.jpg" class="d-block w-100" alt="alberca">
        <div class="carousel-caption d-md-block">
          <h5>PET PARK</h5>
        </div>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div id="desarrollo" class="row justify-content-center align-items-center desarrollo">

      <div class="col-10 col-md-10">
        <div class="row justify-content-center">


          <div class="col-12 col-md-5" data-aos="fade-right" data-aos-anchor-placement="top-bottom">
            <h2>VIVE COMO MERECES</h2>
            <div class="col-12 col-md-12 desp">
              <h5>VENTAJAS</h5>
              <p>Estamos ubicados en la mejor zona de la ciudad<br>Garantía de calidad en la urbanización.<br>Diseño arquitectónico y amenidades de vanguardia.</p>
            </div>

            <div class="col-12 col-md-12 desp">
              <h5>AMENIDADES</h5>
              <p>Casa club con terraza.<br>Alberca.<br>Área de juegos y fogatero.<br>Pet park.<br>Gimnasio.<br>Coworking.<br>Ludoteca.<br>Terraza.</p>
            </div>

            <div class="col-12 col-md-12 desp">
              <h5>EXPERIENCIA</h5>
              <p>Con más de 28 años trabajando en el ramo nos hemos ganado la confianza absoluta de nuestros clientes.</p>
            </div>
          </div>

          <div class="col-12 col-md-7 isometrico" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
            <img src="images/isometrico.png" alt="">
          </div>
        </div>
    ...
    <svg id="lotes" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      <path fill="#436179" fill-opacity="1" d="M0,32L80,58.7C160,85,320,139,480,133.3C640,128,800,64,960,42.7C1120,21,1280,43,1360,53.3L1440,64L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path>
    </svg>

    <div class="row justify-content-center align-items-center lotes">
      <div class="col-10 text-center" data-aos="fade-down" data-aos-anchor-placement="bottom-bottom">
        <h4>PASEOS LEVANA</h4>
        <h2>PREDIOS RESIDENCIALES</h2>
        <p>Interactúa con nuestro mapa digital y conoce las especificaciones de los predios que tenemos disponibles</p>
      </div>
      <div class="col-12">
        <div id="svgcontainer">
          ...
          <svg id="svgmap" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="765" height="520" viewBox="0 0 765 520">
            <style type="text/css">
              .st0 {
                fill: none;
              }
   ...
   L163.8,319.4z" />
              ...
              <path id="lote2a_128" class="st8" d="M231.5,292.8l-0.9-14.8l-32.7,0.6l0,21.5l4.4-2.6c4.2-3.2-6.4,1.3,3.1-1.3
   ...
   L215.6,443.1L215.6,443.1z" />
              <path id="lote_104" class="st7" d="M231.1,441.7l-15.5,1.4l-2.4-33.6c4.5-1.6,9.6-3.1,15.2-4.4L231.1,441.7L231.1,441.7z" />
            ...
            <g id="zona_7">
              <path id="lote_88" class="st8" d="M400.2,311L379,291.5l3.5-5.4l0.4-9.8c9.3,0.9,18.2,1.4,26.7,1.1l0.4,11
   ...
   c0.1,4.5,0.1,9.1,0.2,13.6C285.2,258.3,285.2,258.4,285.2,258.5L285.2,258.5z" />
              <path id="lote_70" class="st8" d="M266.9,289.1c-1.3,0.2-2.7,0.4-4,0.5c-2.1,0.2-4.2,0.4-6.4,0.6c-1.9,0.1-3.7,0.3-5.6,0.3
   ...
   c-0.1-2.8-0.1-5.7-0.1-8.5c0-1.3,0-2.6,0-4c0-0.1,0-0.3,0-0.4C285.2,253.6,285.1,249.1,285,244.5L285,244.5z" />
              <path id="lote_67" class="st8" d="M303.3,280.1c0-1.6,0-3.3-0.1-4.9c-0.1-2.8,0-5.6-0.1-8.4c-0.1-2.4,0-4.8-0.1-7.2
   ...
   C360,201.6,360,201.6,359.9,202.5" />
              <path id="lote_46" class="st8" d="M343.4,202.6c0-0.7,0.4-0.8,1-0.8c1.9,0,3.8,0.1,5.8,0c2.6-0.1,5.2,0,7.8-0.1
   ...
   c0.2,0,0.4,0,0.7,0c4.8-0.1,9.5-0.1,14.3-0.2C462.7,122.1,467.1,122.2,471.5,122L471.5,122L471.5,122z" />
              <path id="lote_39" class="st8" d="M483.2,92.6c0,0.1,0.1,0.2,0.2,0.1c0.1,0.3,0.4,0.5,0.6,0.7c1.1,1.6,1.2,3.3,0.2,5.1
   ...
   c0.6,0.5,1.3,0.8,2,1.1c0.7,0.6,1.4,0.9,2.3,1.2c0.5,0.5,1.1,0.8,1.8,1C482.9,92.6,483.1,92.6,483.2,92.6L483.2,92.6z" />
            ...
            <g id="zona_1">
              ...
              <path id="lote_1" class="st8" d="M645.4,1.1h2.8l2.5,41.4l-12,0.7c-10.6,0.5-22.5,4.8-35.5,12.7c-1,0.3-1.8,0-2.6-0.8l-3-4.2
   l11.8-7.9l25.6-23.5L645.4,1.1L645.4,1.1z" />
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      <path fill="#dfdfdf" fill-opacity="1" d="M0,224L80,234.7C160,245,320,267,480,256C640,245,800,203,960,202.7C1120,203,1280,245,1360,266.7L1440,288L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
    </svg>



    <div id="galeria" class="row justify-content-evenly align-items-center galeria">
      <div class="col-10 col-md-4 order-md-1">
        <img src="images/galeria.png" alt="">
      </div>
      <div class="col-10 col-md-5 order-md-2 galema" data-aos="fade-right" data-aos-anchor-placement="bottom-bottom">
        <h2>GALERÍA</h2>
        <h3>DESCUBRE TU NUEVO HOGAR</h3>
        ...
        <a href="galeria.php" class="btn btn-sm btn-outline-dark">Ver galería</a>
      </div>
    </div>

    <svg id="contacto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      <path fill="#dfdfdf" fill-opacity="1" d="M0,96L80,106.7C160,117,320,139,480,138.7C640,139,800,117,960,117.3C1120,117,1280,139,1360,149.3L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path>
    </svg>

    <div class="row justify-content-center align-items-top contacto">
      <div class="col-10 text-center" data-aos="zoom-in" data-aos-anchor-placement="bottom-bottom">
        <h2 style="margin-bottom:50px;">CONTÁCTO</h2>
      </div>


      <div class="col-10 col-md-5 order-md-2" data-aos="fade-right" data-aos-anchor-placement="bottom-bottom">
        <a href="tel:4494044444" style="display:block;Text-decoration:none;color:#000;">
        <p><i style="color:#436179;" class="bi bi-telephone-fill"></i> Teléfono</p><p style="margin-top: -18px;">449 404 4444</p></a>
        <a href="mailto:administracion@vidalevana.com" style="display:block;Text-decoration:none;color:#000;margin:5px 0px;">
        <p><i style="color:#436179;" class="bi bi-envelope-fill"></i> Email</p> <p style="margin-top: -18px;">ventas@vidalevana.com</p></a>
        <p><i style="color:#436179;" class="bi bi-geo-alt-fill"></i> Dirección</p>
        <p style="margin-top: -18px;">Avenida 1° de Diciembre #401, casi esquina con Av. Del Valle</p>
        <iframe class="galema" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4530.875574227605!2d-102.33951005101969!3d21.914019811229107!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8429efaa959f0fad%3A0xaf7009492008e191!2sLevana!5e0!3m2!1ses-419!2smx!4v1673135318535!5m2!1ses-419!2smx" width="100%" height="280" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>


      <div class="col-10 col-md-4 order-md-1 contactform" data-aos="fade-left" data-aos-anchor-placement="bottom-bottom">
        <form action="correo.php" method="post">
          <div class="row">
            <div class="form-floating col-6">
              <input id="nombre" name="nombre" type="text" class="form-control" required autocomplete="off" placeholder="Nombre">
              <label for="nombre" class="form-label">Nombre (s)</label>
            </div>

            <div class="form-floating mb-3 col-6">
              <input id="floatingInput apellido" name="apellido" type="text" class="form-control" required autocomplete="off" placeholder="Apellidos(s)">
              <label for="floatingInput apellido" class="form-label">Apellido (s)</label>
            </div>

            <div class="form-floating mb-3 col-12">
              <input id="email" name="email" type="email" class="form-control" required autocomplete="off" placeholder="Email">
              <label for="email" class="form-label">Correo electronico:</label>
            </div>

            <div class="form-floating mb-3 col-12">
              <input id="telefono" name="telefono" type="number" class="form-control" required autocomplete="off" placeholder="Teléfono">
              <label for="telefono" class="form-label">Teléfono</label>
            </div>

            <div class="form-floating mb-3 col-12">
              <textarea id="detalles" name="detalles" type="text" class="form-control" required autocomplete="off" placeholder="Detalles" style="min-height: 150px;"></textarea>
  ...
  <div class="floating-button">
        <a href="vialevana.php">Conoce <br>Vía Levana</a>
    </div>
