...
<head>
    ...
    <title>Predios Paseo Levana | Levana</title>
    ...
    <meta property="og:title" content="Predios Paseo Levana | Levana">
...
<div class="row justify-content-center align-items-center" style="margin-top:120px">
    <div class="col-md-8">
        <div class="card text-center">
            ...
            <a href="lotesoriente.php" class="btn btn-primary float-end">Vía Levana</a>
                <h4>PREDIOS PASEO LEVANA</h4>
            </div>
