            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>FINANZAS
                            <a href="nuevafinanza.php" class="btn btn-primary btn-sm float-end">Nueva</a>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td> <?= $registro['cotizacionTotal']; ?></td>
                                            <td> <?= $registro['pendientePagar']; ?></td>
                                            <td><?= $registro['gananciaFinal']; ?></td>
                                            <td>
                                                <a href="editarfinanza.php?id=<?= $registro['id']; ?>" class="btn btn-success btn-sm">Ver / Editar</a>

                                                <form action="finanzascode.php" method="POST" class="d-inline">
