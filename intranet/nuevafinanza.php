                        ...
                        <form action="finanzascode.php" method="POST">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" name="nombreProyecto" id="nombreProyecto" required autocomplete="off">
                                </div>

                                <div class="col-4">
                                    <label for="cotizacionTotal" class="form-label">Cotizacion Total</label>
                                    <input type="text" class="form-control" name="cotizacionTotal" id="cotizacionTotal" value="0" onblur="calcularIVA(); calcularGananciaFinal(); calcularPendientePagar();">
                                </div>

                                <div class="col-4">
                                    <label for="dominio" class="form-label">Dominio</label>
                                    <input type="text" class="form-control" name="dominio" id="dominio" value="0" onblur="calcularGananciaFinal();">
                                </div>

                                <div class="col-4">
                                    <label for="hosting" class="form-label">Hosting</label>
                                    <input type="text" class="form-control" name="hosting" id="hosting" value="0" onblur="calcularGananciaFinal();">
                                </div>

                                <div class="col-4">
                                    <label for="sslCampo" class="form-label">SSL</label>
                                    <input type="text" class="form-control" name="sslCampo" id="sslCampo" value="0" onblur="calcularGananciaFinal();">
                                </div>

                                <div class="col-4">
                                    <label for="otros" class="form-label">Otros</label>
                                    <input type="text" class="form-control" name="otros" id="otros" value="0" onblur="calcularGananciaFinal();">
                                </div>

                                <div class="col-4">
                                    <label for="pagoDesarrolladores" class="form-label">Pago a Desarrolladores</label>
                                    <input type="text" class="form-control" name="pagoDesarrolladores" id="pagoDesarrolladores" value="0" onblur="calcularGananciaFinal();">
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" name="montoPagado" id="montoPagado" value="0" onblur="calcularPendientePagar();">
                                </div>

                                <div class="col-4">
                                    <label for="iva" class="form-label">IVA</label>
                                    <input type="text" class="form-control" name="iva" id="iva" value="0" onblur="calcularGananciaFinal();">
                                </div>

                                <div class="col-4">
                                    <label for="pendientePagar" class="form-label">Pendiente a Pagar</label>
                                    <input type="text" class="form-control" name="pendientePagar" id="pendientePagar" value="0">
                                </div>

                                <div class="col-4">
                                    <label for="gananciaFinal" class="form-label">Ganancia Final</label>
                                    <input type="text" class="form-control" name="gananciaFinal" id="gananciaFinal" value="0">
                                </div>
