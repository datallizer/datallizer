...
<head>
   ...
   <title>Nuevo vuelo | La Boqueria Travel</title>
</head>
<body>

<?php include('sidenav.php'); ?>
   
<form data-aos="zoom-in" action="codeboletos.php" method="post" enctype="multipart/form-data">
   <div  class="container">
       <div style="min-height: 90vh;" class="row justify-content-center align-content-center">
           ...
           <div style="margin-top: 20px;" class="col-12 col-md-9">
               <select name="categoria" class="form-select" aria-label="Default select example">
                   ...
                   <option name="hoteles" value="casa">Nacionales</option>
                   <option name="casas" value="casas">USA</option>
                   <option name="cabanas" value="cabanas">Europa</option>
                   <option name="villas" value="villas">Asia</option>
                   <option name="villas" value="villas">Australia</option>
                   <option name="villas" value="villas">Oriente</option>
                   <option name="villas" value="villas">Sudamerica</option>
                   <option name="villas" value="villas">Africa</option>
               </select>
           </div>
           ...
           <div class="col-11 col-md-9 text-center">
               ...
               <a style="margin: 20px;" class="btn btn-success" href="monitorboletosavion.php">Cancelar</a>
           </div>
