...
<head>
    ...
    <title>Renta de automoviles | La Boqueria Travel</title>
</head>
<body>
...
<div class="container-fluid">
    ...
    <div class="col-10 category_list" style="margin-top:20px;">
            <div style="border:1px solid #e7e7e7;" class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        ...
                        <a href="#" class="category_item" category="Autobus"><i class="bi bi-app"></i> Autobus</a>
                        <a href="#" class="category_item" category="Sprinter"><i class="bi bi-app"></i> Sprinter</a>
                        <a href="#" class="category_item" category="Camioneta"><i class="bi bi-app"></i> Camioneta</a>
                        <a href="#" class="category_item" category="Carro"><i class="bi bi-app"></i> Carro</a>
                        <a href="#" class="category_item" category="Moto"><i class="bi bi-app"></i> Moto</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php
                ...
                echo '<div class="col-12 contbody text-center"><h5> No se encontraron automoviles por el momento </h5></div>';
            }
        ?>
