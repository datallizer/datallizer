...
<head>
    ...
    <title>Nueva reservacion | La Boqueria Travel</title>
</head>
<body>

<?php include('sidenav.php'); ?>
    
<form data-aos="zoom-in" action="codereservaciones.php" method="post" enctype="multipart/form-data">
    <div  class="container">
        <div style="min-height: 90vh;" class="row justify-content-center align-content-center">
            ...
            <div style="margin-top: 20px;" class="col-12 col-md-9">
                <select name="categoria" class="form-select" aria-label="Default select example">
                    ...
                    <option name="hoteles" value="Hoteles">Hoteles</option>
                    <option name="casas" value="Casas">Casas</option>
                    <option name="cabanas" value="Cabañas">Cabañas</option>
            ...
            <div class="col-11 col-md-9 text-center">
                ...
                <a style="margin: 20px;" class="btn btn-success" href="monitorreservaciones.php">Cancelar</a>
            </div>
