...
<head>
   ...
   <link rel="shortcut icon" type="image/x-icon" href="images/ics.ico">
    ...
    <title>Paquetes | La Boqueria Travel</title>
</head>
<body>
...
<div class="container-fluid">
    ...
    <div class="col-10 category_list" style="margin-top:20px;">
            <div style="border:1px solid #e7e7e7;" class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        ...
                        <a href="#" class="category_item" category="Pueblo"><i class="bi bi-app"></i> Pueblo</a>
                        <a href="#" class="category_item" category="Internacional"><i class="bi bi-app"></i> Internacional</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php
                ...
                echo '<div class="col-12 contbody text-center"><h5> No se encontraron paquetes por el momento </h5></div>';
            }
        ?>
