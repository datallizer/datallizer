...
<head>
   ...
   <title>Monitor de excursiones | La Boqueria Travel</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12 m-3">
                <h4>Excursiones
                <a style="margin-left:15px !important;" href="nuevaexcursion.php" class="btn btn-sm btn-primary float-end">Nueva excursion</a>
                </h4>
            </div>
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="editarexcursion.php?id=<?= $registro['id']; ?>" class="btn btn-success btn-sm">Editar</a>
                                <form action="codeexcursiones.php" method="POST" class="d-inline">
