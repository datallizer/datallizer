...
<head>
   ...
   <title>Nuevo circuito turístico | La Boqueria Travel</title>
</head>
<body>

<?php include('sidenav.php'); ?>
   
<form data-aos="zoom-in" action="codecircuitos.php" method="post" enctype="multipart/form-data">
   <div  class="container">
       <div style="min-height: 90vh;" class="row justify-content-center align-content-center">

           <div class="col-12 text-center">
               <h2>NUEVO CIRCUITO TURISTICO</h2>
           </div>
           ...
           <div style="margin-top: 20px;" class="col-12 col-md-9">
               <select name="categoria" class="form-select" aria-label="Default select example">
                   ...
                   <option name="Ciudad" value="casa">Ciudad</option>
                   <option name="Campo" value="casas">Campo</option>
                   <option name="Playa" value="cabanas">Playa</option>
                   <option name="villas" value="Pueblo">Pueblo</option>
               </select>
           </div>
           ...
           <div class="col-11 col-md-9 text-center">
               ...
               <a style="margin: 20px;" class="btn btn-success" href="monitorcircuitos.php">Cancelar</a>
           </div>
