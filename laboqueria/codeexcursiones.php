...
if(isset($_POST['delete']))
{
    ...
    $query = "DELETE FROM excursiones WHERE id='$id' ";
    $query_run = mysqli_query($con, $query);

    if($query_run)
    {
        $_SESSION['message'] = "Eliminado con exito";
        header("Location: monitorexcursiones.php");
        exit(0);
    }
    else
    {
...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE excursiones SET `titulo` = '$titulo', `descripcion` = '$descripcion', `categoria` = '$categoria', `costo` = '$costo', `estado` = '$estado' WHERE id = $id;";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save']))
{
    ...
    $query = "INSERT INTO excursiones SET titulo='$titulo', descripcion='$descripcion', categoria='$categoria', costo='$costo', estado='$estado', imagen='$imagen'";
