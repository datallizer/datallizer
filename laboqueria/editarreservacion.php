...
<head>
   ...
   <title>Editar reservacion | La Boqueria Travel</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM reservaciones WHERE id='$registro_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="codereservaciones.php" method="POST" class="row justify-content-center text-center" style="padding:50px 0px;">
                                    ...
                                    <div class="col-11 col-md-5">
                                        ...
                                        <a href="monitorreservaciones.php" class="btn btn-dark">Cancelar</a>
                                    </div>
