...
<head>
   ...
   <title>Nueva excursion | La Boqueria Travel</title>
</head>
<body>

<?php include('sidenav.php'); ?>
   
<form data-aos="zoom-in" action="codeexcursiones.php" method="post" enctype="multipart/form-data">
   <div  class="container">
       <div style="min-height: 90vh;" class="row justify-content-center align-content-center">

           <div class="col-12 text-center">
               <h2>NUEVA EXCURSION</h2>
           </div>
           ...
           <div class="col-11 col-md-9 text-center">
               ...
               <a style="margin: 20px;" class="btn btn-success" href="monitorexcursiones.php">Cancelar</a>
           </div>
