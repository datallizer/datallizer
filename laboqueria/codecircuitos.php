...
if(isset($_POST['delete']))
{
    ...
    $query = "DELETE FROM circuitos WHERE id='$id' ";
    $query_run = mysqli_query($con, $query);

    if($query_run)
    {
        $_SESSION['message'] = "Eliminado con exito";
        header("Location: monitorcircuitos.php");
        exit(0);
    }
    else
    {
...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE circuitos SET `titulo` = '$titulo', `descripcion` = '$descripcion', `categoria` = '$categoria', `costo` = '$costo', `estado` = '$estado' WHERE id = $id;";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save']))
{
    ...
    $query = "INSERT INTO circuitos SET titulo='$titulo', descripcion='$descripcion', categoria='$categoria', costo='$costo', estado='$estado', imagen='$imagen'";
    $query_run = mysqli_query($con, $query);
    if($query_run)
    {
