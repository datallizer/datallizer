...
<head>
   ...
   <title>Editar crucero | La Boqueria Travel</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM cruceros WHERE id='$registro_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="codecruceros.php" method="POST" class="row justify-content-center text-center" style="padding:50px 0px;">
                                    <h4>EDITAR CRUCERO</h4>
                                    <div class="col-11 col-md-5">
                                        ...
                                        <a href="monitorcruceros.php" class="btn btn-dark">Cancelar</a>
                                    </div>
