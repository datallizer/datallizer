...
<head>
    ...
    <title>Tours | La Boqueria Travel</title>
</head>
<body>
...
<div class="container-fluid">
    <div class="row justify-content-center align-items-top exhib">
            ...
            <div style="border:1px solid #e7e7e7;" class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        ...
                        <a href="#" class="category_item" category="Ciudad"><i class="bi bi-app"></i> Ciudad</a>
                        <a href="#" class="category_item" category="Campo"><i class="bi bi-app"></i> Campo</a>
                        <a href="#" class="category_item" category="Playa"><i class="bi bi-app"></i> Playa</a>
                        <a href="#" class="category_item" category="Pueblo"><i class="bi bi-app"></i> Pueblo mágico</a>
                        </div>
                    </div>
                </div>
            </div>
			...
			<div class="card">
				...
				<div class="card-body">
                    ...
                    <div class="row justify-content-around align-items-center">
                        <div class="col">
                            <a style="z-index:99;" target="_blank" href="https://wa.me/524495412779?text=Hola,%20quiero%20información%20sobre:%0APaquete:%20<?= $registro['titulo']; ?>%0ADestino:%20<?= $registro['estado']; ?>%0ADetalles:%20<?= $registro['descripcion']; ?>%0ACosto:%20$<?= $registro['costo']; ?>" class="btn btn-danger btn-sm"><i class="bi bi-whatsapp"></i> Información</a>
                        </div>
                        <div class="col-5">
        ...
        <?php
                ...
                echo '<div class="col-12 contbody text-center"><h5> No se encontraron tours por el momento </h5></div>';
            }
        ?>
