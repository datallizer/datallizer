...
<head>
    ...
    <title>Cruceros | La Boqueria Travel</title>
</head>
<body>
...
<div class="container-fluid">
    ...
    <div class="col-10 category_list" style="margin-top:20px;">
            <div style="border:1px solid #e7e7e7;" class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        ...
                        <a href="#" class="category_item" category="Nacionales"><i class="bi bi-app"></i> Nacionales</a>
                        <a href="#" class="category_item" category="USA"><i class="bi bi-app"></i> USA</a>
                        <a href="#" class="category_item" category="Europa"><i class="bi bi-app"></i> Europa</a>
                        <a href="#" class="category_item" category="Asia"><i class="bi bi-app"></i> Asía</a>
                        <a href="#" class="category_item" category="Australia"><i class="bi bi-app"></i> Australia</a>
                        <a href="#" class="category_item" category="Oriente"><i class="bi bi-app"></i> Oriente</a>
                        <a href="#" class="category_item" category="Sudamerica"><i class="bi bi-app"></i> Sudamerica</a>
                        <a href="#" class="category_item" category="Africa"><i class="bi bi-app"></i> Africa</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php
                ...
                echo '<div class="col-12 contbody text-center"><h5> No se encontraron cruceros por el momento </h5></div>';
            }
        ?>
