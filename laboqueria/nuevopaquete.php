...
<head>
   ...
   <title>Nuevo paquete | La Boqueria Travel</title>
</head>
<body>

<?php include('sidenav.php'); ?>
   
<form data-aos="zoom-in" action="codepaquetes.php" method="post" enctype="multipart/form-data">
   <div  class="container">
       <div style="min-height: 90vh;" class="row justify-content-center align-content-center">
           ...
           <div class="col-12 col-md-3">
               ...
               <input name="costo" type="number" class="form-control" id="exampleFormControlInput1" autocomplete="off" required pattern="[0-9]+">
           </div>

           <div style="margin-top: 20px;" class="col-12 col-md-9">
               <select name="categoria" class="form-select" aria-label="Default select example">
                   <option disabled selected>Categoría</option>
                   <option name="Ciudad" value="Ciudad">Ciudad</option>
                   <option name="Campo" value="Campo">Campo</option>
                   <option name="Playa" value="Playa">Playa</option>
                   <option name="Pueblo" value="Pueblo">Pueblo</option>
                   <option name="Internacional" value="Internacional">Internacional</option>
               </select>
           </div>
           ...
           <div class="col-11 col-md-9 text-center">
               ...
               <a style="margin: 20px;" class="btn btn-success" href="monitorpaquetes.php">Cancelar</a>
           </div>
