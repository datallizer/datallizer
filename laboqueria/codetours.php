...
if(isset($_POST['delete']))
{
    ...
    if($query_run)
    {
        ...
        header("Location: monitortours.php");
        exit(0);
    }
    else
    {
...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE tours SET titulo='$titulo', descripcion='$descripcion', categoria='$categoria', estado='$estado', costo='$costo', imagen='$imagen' WHERE id = $id; ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save']))
{
    ...
    $query = "INSERT INTO tours SET titulo='$titulo', descripcion='$descripcion', categoria='$categoria',estado='$estado', costo='$costo', imagen='$imagen'";
