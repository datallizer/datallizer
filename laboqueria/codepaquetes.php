...
if(isset($_POST['delete']))
{
    ...
    if($query_run)
    {
        ...
        header("Location: monitorpaquetes.php");
        exit(0);
    }
    else
    {
...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE paquetes SET titulo='$titulo', descripcion='$descripcion', categoria='$categoria', estado='$estado', costo='$costo', imagen='$imagen' WHERE id = $id; ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save']))
{
    ...
    $query = "INSERT INTO paquetes SET titulo='$titulo', descripcion='$descripcion', categoria='$categoria', estado='$estado', costo='$costo', imagen='$imagen'";
