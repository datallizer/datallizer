...
<head>
   ...
   <title>Editar paquete | La Boqueria Travel</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
                ...
                if(isset($_GET['id'])){
                    ...
                    $query = "SELECT * FROM paquetes WHERE id='$registro_id' ";
                    $query_run = mysqli_query($con, $query);

                    if(mysqli_num_rows($query_run) > 0){
                        $registro = mysqli_fetch_array($query_run);
                ?>
                                <form action="codepaquetes.php" method="POST" class="row justify-content-center text-center" style="padding:50px 0px;">
                                    ...
                                    <div class="col-11 col-md-5">
                                        ...
                                        <a href="monitorpaquetes.php" class="btn btn-dark">Cancelar</a>
                                    </div>
