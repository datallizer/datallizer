...
<head>
   ...
   <title>Monitor de traslados | La Boqueria Travel</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12 m-3">
                <h4>Traslados
                <a style="margin-left:15px !important;" href="nuevotraslado.php" class="btn btn-sm btn-primary float-end">Nuevo traslado</a>
                </h4>
            </div>
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="editartraslado.php?id=<?= $registro['id']; ?>" class="btn btn-success btn-sm">Editar</a>
                                <form action="codetraslados.php" method="POST" class="d-inline">
