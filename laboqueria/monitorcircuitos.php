...
<head>
   ...
   <title>Monitor circuitos turisticos | La Boqueria Travel</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12 m-3">
                <h4>Circuitos turísticos
                <a style="margin-left:15px !important;" href="nuevocircuito.php" class="btn btn-sm btn-primary float-end">Nuevo circuito</a>
                </h4>
            </div>
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="editarcircuito.php?id=<?= $registro['id']; ?>" class="btn btn-success btn-sm">Editar</a>
                                <form action="codecircuitos.php" method="POST" class="d-inline">
