...
<head>
   ...
   <title>Monitor vuelos | La Boqueria Travel</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12 m-3">
                <h4>Vuelos
                <a style="margin-left:15px !important;" href="nuevoboleto.php" class="btn btn-sm btn-primary float-end">Nuevo boleto de avion</a>
                </h4>
            </div>
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="editarboleto.php?id=<?= $registro['id']; ?>" class="btn btn-success btn-sm">Editar</a>
                                <form action="codeboletos.php" method="POST" class="d-inline">
