...
if(isset($_POST['delete']))
{
    ...
    $query = "DELETE FROM cruceros WHERE id='$id' ";
    $query_run = mysqli_query($con, $query);

    if($query_run)
    {
        $_SESSION['message'] = "Eliminado con exito";
        header("Location: monitorcruceros.php");
        exit(0);
    }
    else
    {
...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE cruceros SET titulo='$titulo', descripcion='$descripcion', categoria='$categoria', costo='$costo', estado='$estado', imagen='$imagen' WHERE id = $id; ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save']))
{
    ...
    $query = "INSERT INTO cruceros SET titulo='$titulo', descripcion='$descripcion', categoria='$categoria', estado='$estado', costo='$costo', imagen='$imagen'";
