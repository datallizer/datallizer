...
<head>
   ...
   <title>Monitor de reservaciones | La Boqueria Travel</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12 m-3">
                <h4>Reservaciones
                <a style="margin-left:15px !important;" href="nuevareservacion.php" class="btn btn-sm btn-primary float-end">Nueva reservacion</a>
                </h4>
            </div>
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="editarreservacion.php?id=<?= $registro['id']; ?>" class="btn btn-success btn-sm">Editar</a>
                                <form action="codereservaciones.php" method="POST" class="d-inline">
