...
<head>
    ...
    <title>Circuitos turísticos | La Boqueria Travel</title>
</head>
<body>
...
<div class="container-fluid">
    ...
    <div class="col-10 category_list" style="margin-top:20px;">
        ...
        <?php
                ...
                echo '<div class="col-12 contbody text-center"><h5> No se encontraron circuitos turísticos por el momento </h5></div>';
            }
        ?>
